...
- [x] Andrej Karpathy's video series.
- [x] Rewrite all the code blocks on my own eg: Softmax, Crossentropy, Attention, Transformer, and Convolutions.
- [x] The lil book of deep learning.
- [x] Train a GPT on Shakespeare data
- [ ] Read 6 seminal papers
  - [x] Attention is all you need
  - [ ] Stable-diffusion
  - [x] LayerNorm/BatchNorm/Rewrite on my own
...
1. LC (120/150) Ok this is bad, I'm not making progress as I would like to, unless I finish 150 wouldn't be able to spend time on DL stuff.
2. And haven't made progress on System Design.


Bought a keyboard (Roland Go3) bit excited and it can be used a midi and also as a synth, I'm going to make some music!
Next Tuesday, I'm going to do a open mic, show up and sing simple C Major or G major song with a simple strumm patterns.

I'm going to finish LC 150 and DDIA (next two weeks) and going to have a mock with meta engineer at the end of this week
or first day of next week. Also, start applying to other companies in this week, the following useful for next two to three weeks.
- [ ] make sure resume is good to use
- [ ] List down companies (Apple, X, XAI, Anthropic, Google, Meta, Netflix(?), Stripe, Gumroad, Basecamp, Hubspot(?))
- [ ] Get the referrals for the positions.
- [ ] Go through LC questions related to companies and see if I have missed any.
- [ ] Go through System Design questions related to companies and see if I have missed any.

## 2024-04-23

Another day of fight or flight, it's not good for my health. It's always been the same, why I can't plan and do things without reacting to situations all the fucking time. I can see people working, having fun but why is it so hard for me to plan few focused hours, make friends and hang outside. Am I gonna waste my life like this, not making a lot of money or building great products, or having a lot of friends or resting? what's the point of this bruh! all the stress and no fun.

I can do better, because I can analyse the situation and find a solution. I'm not gonna suffer any more, if things get hard at work, I can just submit my resignation and if this country makes me too lonely can sell everything in few days go to bali to work with other digital nomads. I can always come back to usa on O1 visa, it's not that hard to get it. If I have skills to do it. I don't need money if I don't spend it hahaha so I need money.


## 2024-05-12

Brother was here and didnt do much, scheduled a meta interview in 2 weeks and I'm gonna crack the interview this time.


## 2024-05-28

so going to finish transformers, and gonna setup comfy UI in local. hard part is to find intersting data, fine tune and see if I get what I want. css-for-js(?), not sure how long it's gonna take but it's my best bet to become comfortable cause backend can be easy in most cases.
still not sure, how I'm going to apply for AI roles? may be engineer for an AI team may be I need better understaning of deployment or writing system level code or GPU handling code? (George Hotz acquires this knowledge really quickly.)

After under performance with meta interview, feel like need to focus a bit more, it's not useful to loose confidence. I'm going to do a mock interview with a friend this week and also going to apply to other companies.
...
[ecw](https://paulgraham.com/ecw.html) <br/>
[hwh](https://paulgraham.com/hwh.html) <br/>
[smart](https://paulgraham.com/smart.html) <br/>
[determination](https://paulgraham.com/determination.html) <br/>
...
4. Brazil live in freind's town, close to amazon and also learn Capoeira from the masters.
5. Learn to make pizza, bake cakes, pastries, indian desserts and make espresso.


[Almond Buckwheat Cake](https://www.calisson.com/blog/en/financier-au-nougat-noir-et-au-sarrasin/)
...
[Neetcode CheatSheet](https://docs.google.com/spreadsheets/d/1A2PaQKcdwO_lwxz9bAnxXnIQayCouZP6d-ENrBz_NXc/edit#gid=0)

## I wanna get good at building front end interfaces, I can no longer postpone this.
[Eloquent-JavaScript](https://eloquentjavascript.net/)
[TailWind](https://tailwindcss.com/)
[front-end practice](https://www.frontendpractice.com/projects/ableton)
